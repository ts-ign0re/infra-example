...
3. **[Автоматическая инициализация](docs/13-TILT-INITIALIZATION.md)** - Что происходит при `make tilt-up`
...
### База данных
- **[09. Примеры запросов к БД](docs/09-DATABASE-QUERIES.md)** - Event sourcing, multi-tenancy, idempotency
- **[10. Materialized Views](docs/10-MATERIALIZED-VIEWS.md)** - Быстрое чтение данных через views

### Event-Driven Architecture
- **[11. Работа с Avro схемами](docs/11-AVRO-SCHEMAS.md)** - Автоматическая регистрация схем, best practices
...
- **[12. Архитектурные решения](docs/12-ARCHITECTURE-DECISIONS.md)** - Обоснование технических решений
